      ...
      <a href="https://github.com/anujtaosf/ROB450_all_code.git" target="_blank" rel="noopener noreferrer" className="btn btn-outline-dark">GitHub Repo</a>
        ...
        <div className="d-flex justify-content-center align-items-center mb-5">
          ...
          <div style={{ maxWidth: '600px'}}>
            ...
            <p>
              Short-Bot is a compact, human-height robotic platform designed to navigate crowded social environments with minimal disruption. Our goal with Short-Bot was to create a working prototype that is able to traverse from an arbitrary point A to point B, some distance away. This prototype 
              ...
              Our final design stands at 1.24 meters (4.08 ft) tall with a total footprint less than 0.12 square meters. Short-Bot also features a Realsense camera for navigation, 
              lights for visual and directional cues, omnidirectional 
              wheels, and reinforced mechanical supports. While the ETH Zurich Ballbot served as our foundational platform, we 
